...
public class NetworkHelper implements INetworkHelper {
    ...
    public Single<RowsAffectedResponse> changeGroup(int id, int order_num) {
        ...
        return mRetrofitClient.create(TaskService.class).changeGroup(getAuthorizationHeader(), request);
    }
    ...
    public Single<RowsAffectedResponse> changeTask(int id, int order_num) {
        ...
        request.setId(id);
        request.setOrderNum(order_num);
        return mRetrofitClient.create(TaskService.class).changeTask(getAuthorizationHeader(), request);
    }
    ...
    public Single<RowsAffectedResponse> deleteTask(int id) {
        return mRetrofitClient.create(TaskService.class).deleteTask(getAuthorizationHeader(), id);
    }

    @Override
    public Single<RowsAffectedResponse> deleteGroup(int id) {
        return mRetrofitClient.create(TaskService.class).deleteGroup(getAuthorizationHeader(), id);
    }
    ...
    public Single<InsertTaskResponse> insertTask(int groupId, int taskType, String description) {
        ...
        return mRetrofitClient.create(TaskService.class).insertTask(getAuthorizationHeader(), request);
    }
    ...
    public Single<InsertGroupResponse> insertGroup(String name) {
        ...
        return mRetrofitClient.create(TaskService.class).insertGroup(getAuthorizationHeader(), request);
    }
    ...
    public Single<List<GetGroupResponse>> getGroupList() {
        return mRetrofitClient.create(TaskService.class).getGroupList(getAuthorizationHeader());
    }

    @Override
    public Single<List<GetTaskResponse>> getTaskList() {
        return mRetrofitClient.create(TaskService.class).getTaskList(getAuthorizationHeader());
    }

    @Override
    public Single<List<User>> getContact() {
        return mRetrofitClient.create(ContactsService.class).getContacts(getAuthorizationHeader());
    }

    @Override
    public Single<User> getContact(int id) {
        return mRetrofitClient.create(ContactsService.class).getContact(getAuthorizationHeader(), id);
    }

    @Override
    public Single<List<User>> searchContactsByName(String name) {
        return mRetrofitClient.create(ContactsService.class).searchContactsByName(getAuthorizationHeader(), name);
    }

    @Override
    public Single<List<User>> searchContactsByPhone(String phone) {
        return mRetrofitClient.create(ContactsService.class).searchContactsByPhone(getAuthorizationHeader(), phone);
    }

    @Override
    public Single<AuthResponse> authenticateUser(String basic) {
        mBasic = basic;
        return mRetrofitClient.create(UserService.class).authenticateUser(mBasic);
    }

    @Override
    public Single<UserResponse> getCurrentUser(String bearer) {
        mBearer = bearer;
        return mRetrofitClient.create(UserService.class).getCurrentUser(mBearer);
    }
    ...
    public Single<InsertContactResponse> insertContact(int contactId, String contactName) {
        ...
        return mRetrofitClient.create(ContactsService.class).insertContact(getAuthorizationHeader(), request);
    }

    @Override
    public Single<RowsAffectedResponse> deleteContact(int contactId) {
        return mRetrofitClient.create(ContactsService.class).deleteContact(getAuthorizationHeader(), contactId);
    }
    ...
    public Single<UserPositionResponse> updateUserPosition(double latitude, double longitude) {
        ...
        return mRetrofitClient.create(UserService.class).updateUserPosition(getAuthorizationHeader(), request);
    }

    @Override
    public Single<List<ContactPosition>> getContactPositions() {
        return mRetrofitClient.create(ContactsService.class).getContactPositions(getAuthorizationHeader());
    }

    @Override
    public Single<RegisterResponse> registerUser(String basic, User user) {
        mBasic = basic;
        return mRetrofitClient.create(UserService.class).registerUser(user);
    }

    public String getAuthorizationHeader(){
        Log.i(TAG, mBearer + " " + mBasic);
        if (mBasic == null) return mBearer;
        else return mBasic;
    }
